...
const SinglePage = () => {
  ...
  return (
    <>
      <section>
        <div className="container mx-auto max-w-[1440px] w-full  grid lg:grid-cols-2 gap-10 px-5">
          <img
          ...
          <div className="flex flex-col gap-5">
            ...
            <p className="max-[600px]:text-[14px] max-[600px]:text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 my-10">
            {Array(6)
              ...
              .map((_, idx) => (
                <div
                  key={idx}
                  className="w-full h-auto border-[2px] border-[#0000001A] rounded-[20px] p-5"
                >
